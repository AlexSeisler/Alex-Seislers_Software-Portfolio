...
const featuredProjects = projectsData.filter(p => [2, 12, 6].includes(p.id));
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1C] pt-20">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-8 text-center">Supporting Projects</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projectsData.filter(p => ![2, 12].includes(p.id)).slice(0, 6).map((project, index) => (
              <motion.div
                key={project.id}
